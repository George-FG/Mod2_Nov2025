...
// Suicidal AI: Wants to lose by minimizing own material
export function evaluateSuicidal(board: Board, color: PieceColor): number {
  let myMaterial = 0;
  ...
  // Return NEGATIVE of own material (lower own material = better for this AI)
